...
if __name__ == '__main__':
    # make_best_in_all()
    model_dir = "/mount/arbeitsdaten56/projekte/synthesis/srivasvv/thesis-playground/tts-postnet-eval/IMS-Toucan/Models/PortaSpeech_LJSpeech_FrozenCNN2D_NoSG_0_001"
