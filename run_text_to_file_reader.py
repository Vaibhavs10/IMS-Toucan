...
if __name__ == '__main__':
    ...
    # read_harvard_sentences(model_id="LJSpeech_FrozenUnivGAN_NoSG_0_001", device="cuda:5")
    read_mos_sentences(model_id="LJSpeech_FrozenUnivGAN_NoSG_0_001", device="cuda:5")
