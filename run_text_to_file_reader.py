...
if __name__ == '__main__':
    ...
    # read_harvard_sentences(model_id="LJSpeech_FrozenCNN1D_SG_0_001", device="cuda:0")
    read_lj50_sentences(model_id="LJSpeech_FrozenCNN1D_SG_0_001", device="cuda:0")    
    # read_mos_sentences(model_id="LJSpeech_FrozenCNN1D_SG_0_001", device="cuda:0")