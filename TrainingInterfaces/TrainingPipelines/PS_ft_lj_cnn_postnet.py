...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_FrozenCNN_0_001")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    train_loop(net=model,
               ...
               batch_size=196,  # YOU MIGHT GET OUT OF MEMORY ISSUES ON SMALL GPUs, IF SO, DECREASE THIS.
