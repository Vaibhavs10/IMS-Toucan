...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_FrozenSD_0_00005_10k_90k_stp")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    all_train_sets.append(ConcatDataset(datasets))
    ...
    train_loop(net=model,
               ...
               path_to_checkpoint=os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_FrozenSD_0_0005_10k_90k_stp",
