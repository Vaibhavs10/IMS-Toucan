...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_FrozenSDiff_0_001_lg")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    train_loop(net=model,
               ...
               batch_size=192,  # YOU MIGHT GET OUT OF MEMORY ISSUES ON SMALL GPUs, IF SO, DECREASE THIS.
