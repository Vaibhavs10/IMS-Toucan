...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_FrozenSDiff_0_0015_10k_lin_15k")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    train_loop(net=model,
               ...
               path_to_checkpoint=os.path.join(MODELS_DIR, "PortaSpeech_LJSpeech_No_0_002_scratch",
