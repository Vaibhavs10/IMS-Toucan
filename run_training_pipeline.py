...
from TrainingInterfaces.TrainingPipelines.PS_ft_lj_gan_postnet import run as ps_ft_lj_gan_postnet
from TrainingInterfaces.TrainingPipelines.PS_ft_lj_gan_postnet_scratch import run as ps_ft_lj_gan_postnet_scratch
...
pipeline_dict = {
    ...
    "ps_ft_lj" : ps_ft_lj_gan_postnet,
    "ps_ft_lj_scratch" : ps_ft_lj_gan_postnet_scratch,    
}
